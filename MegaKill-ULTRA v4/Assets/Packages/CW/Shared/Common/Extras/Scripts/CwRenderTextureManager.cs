...
namespace CW.Common
{
    ...
    public class CwRenderTextureManager : MonoBehaviour
    {
        ...
        private static LinkedList<CwRenderTextureManager> instances =
            new LinkedList<CwRenderTextureManager>();
        ...
        {
            if (a.enableRandomWrite != b.enableRandomWrite)
                return false;
            if (a.autoGenerateMips != b.autoGenerateMips)
                return false;
            if (a.useMipMap != b.useMipMap)
                return false;
            if (a.memoryless != b.memoryless)
                return false;
            if (a.flags != b.flags)
                return false;
            if (a.vrUsage != b.vrUsage)
                return false;
            if (a.shadowSamplingMode != b.shadowSamplingMode)
                return false;
            if (a.dimension != b.dimension)
                return false;
            if (a.depthBufferBits != b.depthBufferBits)
                return false;
            if (a.stencilFormat != b.stencilFormat)
                return false;
            if (a.colorFormat != b.colorFormat)
                return false;
            if (a.bindMS != b.bindMS)
                return false;
            if (a.graphicsFormat != b.graphicsFormat)
                return false;
            if (a.mipCount != b.mipCount)
                return false;
            if (a.volumeDepth != b.volumeDepth)
                return false;
            ...
            if (a.sRGB != b.sRGB)
                return false;
            if (a.useDynamicScale != b.useDynamicScale)
                return false;
...
namespace CW.Common
{
    ...
    public class CwRenderTextureManager_Editor : CwEditor
    {
        protected override void OnInspector()
        {
            ...
            Draw(
                "lifetime",
                "This allows you to set how many frames an unused RenderTexture will remaining in memory before it's released."
            );
        }
    }
}
