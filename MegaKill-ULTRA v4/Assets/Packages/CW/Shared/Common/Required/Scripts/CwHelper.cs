    ...
    public static partial class CwHelper
    {
            ...
            where T : Object
        {
            ...
            return Object.FindAnyObjectByType<T>(
                includeInactive == true ? FindObjectsInactive.Include : FindObjectsInactive.Exclude
            );
#else
            ...
            where T : Component
        {
            if (gameObject != null)
            {
                ...
                if (component == null)
                    component = AddComponent<T>(gameObject, recordUndo);
        ...
        public static Texture2D GetReadableCopy(
            Texture texture,
            TextureFormat format = TextureFormat.ARGB32,
            bool mipMaps = false,
            int width = 0,
        ...
        )
        {
            ...
            if (texture != null)
            {
                ...
                var renderTexture = CwRenderTextureManager.GetTemporary(
                    desc,
