...
namespace CW.Common
{
    ...
    public static class CwInput
    {
        ...
        private static UnityEngine.InputSystem.Controls.ButtonControl GetMouseButtonControl(
            int index
        )
        {
            if (UnityEngine.InputSystem.Mouse.current != null)
            {
                switch (index)
                {
                    ...
                    case 3:
                        return UnityEngine.InputSystem.Mouse.current.forwardButton;
                    case 4:
                        return UnityEngine.InputSystem.Mouse.current.backButton;
                }
            }
        ...
        private static UnityEngine.InputSystem.Controls.ButtonControl GetButtonControl(
            KeyCode oldKey
        )
        {
            if (UnityEngine.InputSystem.Mouse.current != null)
        ...
        {
#if USE_NEW_INPUT_SYSTEM
            var buttonControl = GetButtonControl(oldKey);
        ...
        {
#if USE_NEW_INPUT_SYSTEM
            return UnityEngine.InputSystem.Mouse.current.scroll != null
