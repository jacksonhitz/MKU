...
namespace CW.Common
{
    ...
    public abstract class CwEditor : UnityEditor.Editor
    {
        ...
        public static bool DrawIntSlider(
            string propertyPath,
            int min,
            int max,
            string overrideTooltip = null,
        ...
        public static bool DrawVector4(
            string propertyPath,
            string overrideTooltip = null,
            string overrideText = null
        )
        ...
        public static bool DrawIntPopup(
            int[] values,
            GUIContent[] contents,
            string propertyPath,
            string overrideTooltip = null,
        ...
        public static void DrawIntPopup(
            int[] values,
            GUIContent[] contents,
            string propertyPath,
            ref bool modified,
        ...
        private static SerializedProperty GetPropertyAndSetCustomContent(
            string propertyPath,
            string overrideTooltip,
            string overrideText
        )
        {
            ...
            customContent.text =
                string.IsNullOrEmpty(overrideText) == false ? overrideText : property.displayName;
            customContent.tooltip =
                string.IsNullOrEmpty(overrideTooltip) == false ? overrideTooltip : property.tooltip;
