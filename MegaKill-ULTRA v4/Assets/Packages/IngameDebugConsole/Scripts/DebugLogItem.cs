...
#pragma warning restore 0649
        ...
        public void Initialize(DebugLogRecycledListView listView)
        {
            ...
            copyLogButtonHeight =
                (copyLogButton.transform as RectTransform).anchoredPosition.y
                + (copyLogButton.transform as RectTransform).sizeDelta.y
        ...
        public void SetContent(
            ...
            DebugLogEntryTimestamp? logEntryTimestamp,
            int entryIndex,
            bool isExpanded
        )
        {
        ...
        {
            if (
                !logEntryTimestamp.HasValue
                || (!isExpanded && !listView.manager.alwaysDisplayTimestamps)
            )
        ...
        public float CalculateExpandedHeight(
            DebugLogEntry logEntry,
            DebugLogEntryTimestamp? logEntryTimestamp
        )
        {
