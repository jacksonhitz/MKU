...
namespace IngameDebugConsole
{
    public class DebugLogEntry
    {
        ...
        public bool MatchesSearchTerm(string searchTerm)
        {
            return (
                    logString != null
                    && DebugLogConsole.caseInsensitiveComparer.IndexOf(
                        logString,
                        searchTerm,
        ...
        public int GetContentHashCode()
        {
            if (hashValue == HASH_NOT_CALCULATED)
            {
                unchecked
                {
                    ...
                    hashValue =
                        hashValue * 23 + (stackTrace == null ? 0 : stackTrace.GetHashCode());
                }
            }
    ...
    public struct DebugLogEntryTimestamp
    {
        ...
        public void AppendFullTimestamp(StringBuilder sb)
        {
            ...
            sb.Append("[")
                .Append(elapsedSeconds.ToString("F1"))
                .Append("s at ")
                .Append("#")
                .Append(frameCount)
                .Append("]");
