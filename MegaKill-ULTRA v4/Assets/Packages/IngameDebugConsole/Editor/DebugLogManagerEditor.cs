...
namespace IngameDebugConsole
{
    ...
    public class DebugLogManagerEditor : Editor
    {
        ...
        private readonly GUIContent popupVisibilityLogFilterLabel = new GUIContent(
            "Log Filter",
            "Determines which log types will show the popup on screen"
        );
        private readonly GUIContent receivedLogTypesLabel = new GUIContent(
            "Received Log Types",
        ...
        private void OnEnable()
        {
            ...
            logsToRemoveAfterMaxLogCount = serializedObject.FindProperty(
                "logsToRemoveAfterMaxLogCount"
            );
            queuedLogLimit = serializedObject.FindProperty("queuedLogLimit");
            clearCommandAfterExecution = serializedObject.FindProperty(
            ...
            receiveLogcatLogsInAndroid = serializedObject.FindProperty(
            ...
            autoFocusOnCommandInputField = serializedObject.FindProperty(
                "autoFocusOnCommandInputField"
            );
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (popupVisibility.intValue == (int)PopupVisibility.WhenLogReceived)
            {
                ...
                popupVisibilityLogFilter.intValue = (int)
                    (DebugLogFilter)
                        EditorGUI.EnumFlagsField(
                            rect,
                            popupVisibilityLogFilterLabel,
                            (DebugLogFilter)popupVisibilityLogFilter.intValue
                        );
