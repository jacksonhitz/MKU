...
namespace Redcode.Extensions
{
    public static class IEnumerableExtensions
    {
        ...
        public static (T element, int index) GetRandomElementWithProbability<T>(
            this IEnumerable<T> enumerable,
            params float[] probabilities
        ) => GetRandomElementWithProbability(enumerable, (IEnumerable<float>)probabilities);
        ...
        )
        {
            ...
            if (probabilities.Count() != count)
                throw new ArgumentException(
                    $"Count of probabilities and enumerble elements must be equal."
                );
        ...
        {
            return GetRandomElementWithProbability(
                enumerable,
                enumerable.Select(el => probabilitySelector(el))
            );
        }
