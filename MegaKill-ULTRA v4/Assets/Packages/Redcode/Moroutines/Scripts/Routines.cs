...
namespace Redcode.Moroutines
{
    ...
    public static class Routines
    {
        ...
        /// <returns><inheritdoc cref="Delay(float, Action)"/></returns>
        public static IEnumerable Delay(float delay, IEnumerator enumerator) =>
            Delay(delay, new EnumerableEnumerator(enumerator));
        ...
        /// <returns><inheritdoc cref="Delay(float, Action)"/></returns>
        public static IEnumerable FrameDelay(int count, IEnumerator enumerator) =>
            FrameDelay(count, new EnumerableEnumerator(enumerator));
