...
namespace Redcode.Moroutines.Extensions
{
    public static class GameObjectExtensions
    {
        ...
        {
            return GetMoroutines(
                gameObject,
                Moroutine.State.Reseted
                    | Moroutine.State.Running
                    | Moroutine.State.Stopped
                    | Moroutine.State.Completed
            );
        }
        ...
        /// <returns>Associated moroutines.</returns>
        public static List<Moroutine> GetMoroutines(
            this GameObject gameObject,
            Moroutine.State mask
        )
        {
