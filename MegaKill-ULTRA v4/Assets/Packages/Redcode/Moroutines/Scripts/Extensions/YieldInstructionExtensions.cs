...
namespace Redcode.Moroutines.Extensions
{
    ...
    {
        public static Moroutine AsMoroutine(this YieldInstruction instruction) =>
            Moroutine.Run(Routines.Wait(instruction));

        public static CustomYieldInstruction AsCustomYieldInstruction(
