...
namespace Redcode.Moroutines.Extensions
{
    public static class CustomYieldInstructionExtensions
    {
        ...
        public static Moroutine AsMoroutine(this CustomYieldInstruction instruction) =>
            Moroutine.Run(instruction);
        ...
        public static YieldInstruction AsYieldInstruction(
            this CustomYieldInstruction instruction
        ) => instruction.AsMoroutine().WaitForComplete();
    }
}
