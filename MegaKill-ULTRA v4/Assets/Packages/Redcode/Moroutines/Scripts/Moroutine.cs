...
namespace Redcode.Moroutines
{
    ...
    public sealed class Moroutine
    {
        ...
        internal class CompleteAwaiter : MoroutineAwaiter
        {
            ...
            public CompleteAwaiter(Moroutine moroutine)
                : base(moroutine) => _enumerator = moroutine._enumerator;

            /// <summary>
            /// Should we continue to wait for the moroutine to be completed, or has it already been completed?
            /// </summary>
            public override bool KeepWaiting =>
                _enumerator == _moroutine._enumerator
        ...
        internal class StopAwaiter : MoroutineAwaiter
        {
            ...
            /// </summary>
            /// <param name="moroutine"><inheritdoc cref="MoroutineAwaiter(Moroutine)"/></param>
            public StopAwaiter(Moroutine moroutine)
                : base(moroutine) => _coroutine = moroutine._coroutine;

            /// <summary>
            /// Should we continue to wait for the moroutine to be stopped, or has it already been stopped?
            /// </summary>
            public override bool KeepWaiting =>
                _coroutine == _moroutine._coroutine && _moroutine.IsRunning;
        }
        ...
        internal class RunAwaiter : MoroutineAwaiter
        {
            ...
            /// </summary>
            /// <param name="moroutine"><inheritdoc cref="MoroutineAwaiter(Moroutine)"/></param>
            public RunAwaiter(Moroutine moroutine)
                : base(moroutine) => _coroutine = moroutine._coroutine;
        ...
        internal class ResetAwaiter : MoroutineAwaiter
        {
            ...
            /// </summary>
            /// <param name="moroutine"><inheritdoc cref="MoroutineAwaiter(Moroutine)"/></param>
            public ResetAwaiter(Moroutine moroutine)
                : base(moroutine) => _enumerator = moroutine._enumerator;
        ...
        internal class DestroyAwaiter : MoroutineAwaiter
        {
            ...
            /// </summary>
            /// <param name="moroutine"><inheritdoc cref="MoroutineAwaiter(Moroutine)"/></param>
            public DestroyAwaiter(Moroutine moroutine)
                : base(moroutine) { }
        ...
        public static List<Moroutine> GetUnownedMoroutines() =>
            MoroutinesExecuter.Instance.gameObject.GetMoroutines();
        ...
        public static Moroutine Create(IEnumerable enumerable) =>
            Create((GameObject)null, enumerable);
        ...
        /// <param name="enumerable"><inheritdoc cref="Create(IEnumerable)" path="/param[@name='enumerable']"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Create(GameObject owner, IEnumerable enumerable) =>
            new(owner, enumerable);
        ...
        /// <param name="enumerable"><inheritdoc cref="Create(IEnumerable)"/></param>
        /// <returns><inheritdoc cref="Create(IEnumerator)"/></returns>
        public static Moroutine Run(GameObject owner, IEnumerable enumerable) =>
            Create(owner, enumerable).Run();
        #endregion
        ...
        /// Calling the <see cref="Reset"/> method will reset the state of the moroutine.</param>
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Create(params IEnumerable[] enumerables) =>
            Create((GameObject)null, enumerables);
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Create(
            ...
            SetAutoDestroy(
                Create(
                    ownersComponent,
                    enumerators.Select(e => new EnumerableEnumerator(e)).ToArray()
                )
            );
        ...
        public static List<Moroutine> Create(
            Component ownersComponent,
            params IEnumerable[] enumerables
        ...
        public static List<Moroutine> Create(GameObject owner, params IEnumerator[] enumerators) =>
            SetAutoDestroy(
                Create(owner, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray())
            );
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Run(params IEnumerable[] enumerables) =>
            Run((GameObject)null, enumerables);
        ...
        /// <returns><inheritdoc cref="Create(IEnumerator[])"/></returns>
        public static List<Moroutine> Run(
            Component ownersComponent,
            params IEnumerator[] enumerators
        ) =>
            SetAutoDestroy(
                Run(ownersComponent, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray())
            );
        ...
        public static List<Moroutine> Run(GameObject owner, params IEnumerator[] enumerators) =>
            SetAutoDestroy(
                Run(owner, enumerators.Select(e => new EnumerableEnumerator(e)).ToArray())
            );
        ...
        /// <param name="action"><inheritdoc cref="OnReseted(Action{Moroutine})"/></param>
        /// <returns>The moroutine.</returns>
        public Moroutine OnCompleted(Action<Moroutine> action) =>
            OnSubscribe(ref Completed, action);
        ...
        /// <param name="action"><inheritdoc cref="OnReseted(Action{Moroutine})"/></param>
        /// <returns>The moroutine.</returns>
        public Moroutine OnDestroyed(Action<Moroutine> action) =>
            OnSubscribe(ref Destroyed, action);
        #endregion
