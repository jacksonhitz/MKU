...
namespace Redcode.Moroutines
{
    ...
    public class WaitForAny : CustomYieldInstruction
    {
        ...
        public WaitForAny(params Moroutine[] moroutines)
            : this(moroutines.Select(m => m.WaitForComplete()).ToList()) { }

        /// <summary>
        /// Create object which will waiting moroutines.
        /// </summary>
        /// <param name="moroutines">Target moroutines.</param>
        public WaitForAny(IList<Moroutine> moroutines)
            : this(moroutines.Select(m => m.WaitForComplete()).ToList()) { }
        ...
        public WaitForAny(params IEnumerator[] instructions)
            : this((IEnumerable<IEnumerator>)instructions) { }
