...
public class UEye : MonoBehaviour
{
    ...
    [SerializeField]
    Texture eye100Texture;

    [SerializeField]
    Texture eye80Texture;

    [SerializeField]
    Texture eye75Texture;

    [SerializeField]
    Texture eye60Texture;

    [SerializeField]
    Texture eye50Texture;

    [SerializeField]
    Texture eye40Texture;

    [SerializeField]
    Texture eye25Texture;

    [SerializeField]
    Texture eye20Texture;

    [SerializeField]
    Texture eye10Texture;

    [SerializeField]
    Texture eyeFlashTexture;

    [SerializeField]
    Texture eye100Texture2;

    [SerializeField]
    Texture eye80Texture2;

    [SerializeField]
    Texture eye75Texture2;

    [SerializeField]
    Texture eye60Texture2;

    [SerializeField]
    Texture eye50Texture2;

    [SerializeField]
    Texture eye40Texture2;

    [SerializeField]
    Texture eye25Texture2;

    [SerializeField]
    Texture eye20Texture2;

    [SerializeField]
    Texture eye10Texture2;

    [SerializeField]
    Texture eyeFlashTexture2;

    [SerializeField]
    Texture eyeHurtTexture;

    [SerializeField]
    Texture eyeHealTexture;
    ...
    public bool Active
    {
        get => currentEye.enabled;
        set => currentEye.enabled = value;
    }
    ...
    Texture GetEye()
    {
        ...
        {
            if (health > 80)
                return eye100Texture2;
            if (health > 60)
                return eye80Texture2;
            if (health > 40)
                return eye60Texture2;
            if (health > 20)
                return eye40Texture2;
            if (health > 10)
                return eye20Texture2;
